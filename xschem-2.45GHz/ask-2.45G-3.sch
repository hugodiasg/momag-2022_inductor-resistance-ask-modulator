...
C {sky130_fd_pr/cap_mim_m3_2.sym} 400 -260 0 0 {name=C0 model=cap_mim_m3_2 W=25.7 L=25.7 MF=3 spiceprefix=X}
...
spiceprefix=X
mult=1}
C {/home/hugodg/projects-sky130/sbmo-2022_inductor-resistance-ask-modulator/xschem-2.45GHz/l3-2.45G.sym} 540 -275 1 0 {name=x1}
